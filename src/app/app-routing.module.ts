...
const routes: Routes = [
  ...
  { path: 'credit-page', loadChildren: './home/credit/modal/credit-page/credit-page.module#CreditPagePageModule' },
  { path: 'credit-modal', loadChildren: './home/credit/modal/credit-modal/credit-modal.module#CreditModalPageModule' },
